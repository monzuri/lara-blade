    ...
    <main class="main-wrap">
        ...
        <section class="content-main">
            <div class="content-header">
                ...
                <div><a class="btn btn-primary" href="#"><i class="text-muted material-icons md-post_add"></i>Add New
                        Brand</a></div>
            </div>
            <div class="card mb-4">
                    ...
                    <div class="row gx-3">
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-1.jpg" alt="Logo"></div>
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-2.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-3.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-4.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-5.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-6.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-7.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-8.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-9.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-10.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-11.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-12.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-13.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-14.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                                    <h6 class="card-title m-0">Company name</h6><a href="#"> 13 items</a>
                                </figcaption>
                            </figure>
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-15.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                                    <h6 class="card-title m-0">Company name</h6><a href="#"> 398 items</a>
                                </figcaption>
                            </figure>
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-16.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                                    <h6 class="card-title m-0">Company name</h6><a href="#"> 13 items</a>
                                </figcaption>
                            </figure>
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-17.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                                    <h6 class="card-title m-0">Company name</h6><a href="#"> 13 items</a>
                                </figcaption>
                            </figure>
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            <figure class="card border-1">
                                <div class="card-header bg-white text-center"><img class="img-fluid" height="76"
                                        src="assets/imgs/brands/brand-18.jpg" alt="Logo"></div>
                                <figcaption class="card-body text-center">
                                    <h6 class="card-title m-0">Company name</h6><a href="#"> 13 items</a>
                                </figcaption>
                            </figure>
