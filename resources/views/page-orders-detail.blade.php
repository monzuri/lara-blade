                ...
                <header class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6 ms-auto text-md-end">
                            ...
                            </select><a class="btn btn-primary" href="#">Save</a><a
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="box shadow-sm bg-light">
                                ...
                                <p><img class="border" src="assets/imgs/card-brands/2.png" height="20"> Master Card
                                    **** **** 4768<br> Business name: Grand Market LLC<br> Phone: +1 (800) 555-154-52</p>
                            </div>
                            <div class="h-25 pt-4">
                                <div class="mb-3">
                                    <label>Notes</label>
