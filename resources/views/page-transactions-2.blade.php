                    ...
                    <div class="row">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="icontext"><img class="icon border"
                                                        src="assets/imgs/card-brands/1.png" alt="Payment"><span
                                                        class="text text-muted">Amex</span></div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="icontext"><img class="icon border"
                                                        src="assets/imgs/card-brands/2.png" alt="Payment"><span
                                                        class="text text-muted">Master card</span></div>
                                            </td>
                                            <td>16.12.2022, 14:21</td>
                                            <td class="text-end"><a class="btn btn-sm btn-light font-sm rounded"
                                                    href="#">Details</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="icontext"><img class="icon border"
                                                        src="assets/imgs/card-brands/3.png" alt="Payment"><span
                                                        class="text text-muted">Paypal</span></div>
                                            </td>
                                            <td>16.12.2022, 14:21</td>
                                            <td class="text-end"><a class="btn btn-sm btn-light font-sm rounded"
                                                    href="#">Details</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="icontext"><img class="icon border"
                                                        src="assets/imgs/card-brands/4.png" alt="Payment"><span
                                                        class="text text-muted">Visa</span></div>
                                            </td>
                                            <td>16.12.2022, 14:21</td>
                                            <td class="text-end"><a class="btn btn-sm btn-light font-sm rounded"
                                                    href="#">Details</a></td>
                        ...
                        <aside class="col-lg-3">
                            <div class="box bg-light" style="min-height:80%">
                                ...
                                <p><a href="#">Adidas Air Jordan<i
                                            class="icons material-icons md-launch"></i></a><br><a href="#">Great
                                        product<i class="icons material-icons md-launch"></i></a></p><br>
                                <p>Payment: PayPal</p>
                                <p class="h4">$457.14</p>
